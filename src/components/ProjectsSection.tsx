...
const projects = [
  ...
  },
  {
    ...
    description: 'No-code workflow automation platform integrating AI models with business processes. Supports webhooks, scheduled tasks, and custom integrations.',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=500&fit=crop',
    tech: ['React', 'n8n', 'Node.js', 'PostgreSQL', 'Redis'],
    liveUrl: '#',
    githubUrl: '#',
    featured: true,
  },
